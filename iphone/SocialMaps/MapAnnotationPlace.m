...
- (MKAnnotationView*) getViewForStateNormal:(LocationItem*) locItem {
    ...
    imageView2.frame = CGRectMake(imageView2.frame.origin.x * 1.15 + 3, imageView2.frame.origin.y * 1.15 + 3, imageView2.frame.size.width * .85 - 6, imageView2.frame.size.height * .85 - 6);
