...
{	
	...
	public static String upload(Uri imageUri, String serverUrl, Context c) 
	{
		...
		try 
		{
			...
			Cursor cursor = c.getContentResolver().query(imageUri,filePathColumn, null, null, null);
			cursor.moveToFirst();
			...
			outputStream.writeBytes("Content-Disposition: form-data; name=\"original_image_bynary\";filename=\"" + filePath + "\"" + lineEnd);
	...
	public static Response parseResponse(String responseString)
	{
		...
		catch (Exception e)
		{
			...
			response.setMessage("Error occured during parse json");
			response.setData("");
	...
	public static String createUrl(String serverUrl, HashMap<String,String> paramMap, String separator) 
	{
		int paramCounter = 0;
