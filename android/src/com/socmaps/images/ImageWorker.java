...
public abstract class ImageWorker {
	...
	private HashMap<String, String> itemIds = new HashMap<String, String>();
	...
	public void loadImage(Object data, ImageView imageView,
			ImageDownloadListener imageDownloadListener, String itemId) {
		...
		if (bitmap != null) {
			...
			try {
				...
				imageDownloadListener.onDownloadComplete(itemId, bitmap,
						String.valueOf(data));
		...
		// else if (cancelPotentialWork(data, imageView)) {
			...
			itemIds.put(String.valueOf(data), itemId);
	...
	private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
		...
		protected Bitmap doInBackground(Object... params) {
			...
			try {
				if (bitmap != null) {
					imageDownloadListener.onDownloadComplete(
							itemIds.get(dataString), bitmap, dataString);
				}
			} catch (NullPointerException e) {
				// TODO: handle exception
			} catch (Exception e) {
