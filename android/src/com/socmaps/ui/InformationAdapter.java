...
public class InformationAdapter extends ArrayAdapter<Information>
{
	...
	public InformationAdapter(Context context, int layoutResourceId,Information[] data)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
        ...
        if(row == null)
        {
            ...
            holder.chkInfoSharingSettings = (CheckBox)row.findViewById(R.id.chkInfoSharingSettings);
