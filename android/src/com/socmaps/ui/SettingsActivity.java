...
public class SettingsActivity extends Activity {
	...
	Button btnBack,btnNotification, btnAccountSettings, btnInformationSharing, btnLocationSharing, btnNotifications, btnPlatforms, btnLayers;
	...
	private class ButtonClickListener implements View.OnClickListener
	{
		...
		public void onClick(View v) {
			...
			{
				Intent informationSharingSettingsIntent = new Intent(getApplicationContext(), InformationSharingSettingsActivity.class);
				startActivity(informationSharingSettingsIntent);	
			}
			else if(v == btnLocationSharing)
			{
				//Intent locationSharingSettingsIntent = new Intent(getApplicationContext(), LocationSharingSettingsActivity.class);
				//startActivity(locationSharingSettingsIntent);	
			}
			else if(v == btnNotifications)
			{
				Intent notificationsSettingsIntent = new Intent(getApplicationContext(), NotificationPreferencesActivity.class);
				startActivity(notificationsSettingsIntent);	
			}
			else if(v == btnPlatforms)
			{
				Intent platformsSettingsIntent = new Intent(getApplicationContext(), PlatformPreferencesActivity.class);
				startActivity(platformsSettingsIntent);	
			}
			else if(v == btnLayers)
			{
				Intent layersSettingsIntent = new Intent(getApplicationContext(), LayerPreferencesActivity.class);
