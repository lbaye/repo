...
public class PlanEditActivity extends Activity implements PeoplePickerListener { 
	...
	private void setDefaultValues() 
	{
		if(selectedPlan != null) 
		{
			...
			{
				//eventDateString = selectedPlan.getPlanTime().getDateTimeValue(); 
				eventDateString = Utility.getFormattedDisplayDateEventList(selectedPlan.getPlanTime());
	...
	private Runnable sendPlanThread = new Runnable() {
		...
		public void run() { // TODO Auto-generated method stub
			RestClient restClient = new RestClient(Constant.smPlanUrl + "/" + selectedPlan.getPlanId());
