...
public class PlatformPreferencesActivity extends Activity implements OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.platform_preferences);
	...
	protected void onResume() {
		...
		super.onResume();
		if(AppStaticStorages.platformsEntity==null)
		{
			startDialogAndBgThread();
		}
		else
		{
			setFieldValues(AppStaticStorages.platformsEntity);
		}
	}
	
	private void setFieldValues(PlatformsEntity platformsEntity) {
		// TODO Auto-generated method stub
		
		setRadioGroupValue(radioGroupFb,platformsEntity.getFb());
		setRadioGroupValue(radioGroup4sq,platformsEntity.getFourSqr());
		setRadioGroupValue(radioGroupGooglePlus,platformsEntity.getGooglePlus());
	...
	public void handlePlatformSettingsResponse(int status, String response) {
		...
		case Constant.STATUS_SUCCESS:
			PlatformsEntity platformsEntity=ServerResponseParser.parsePlatformsSettings(response);
			setFieldValues(platformsEntity);
			AppStaticStorages.platformsEntity=platformsEntity;
			break;
	...
	private Runnable getPlatformSettingsInfo=new Runnable() {
		...
		public void run() {
			// TODO Auto-generated method stub
			RestClient getPlatformSettingsClient=new RestClient(Constant.platformsSettingsUrl);
	...
	private void initialize() 
	{
		...
		/*chkFB=(CheckBox) findViewById(R.id.chkFB);		
		chk4sq=(CheckBox) findViewById(R.id.chk4sq);		
		chkGplus=(CheckBox) findViewById(R.id.chkGplus);
	...
	public void handleResponse(int status, String response) {
		...
		case Constant.STATUS_SUCCESS:
			...
			Toast.makeText(getApplicationContext(),
					...
					.show();
			AppStaticStorages.platformsEntity=ServerResponseParser.parsePlatformsSettings(response);
			break;
