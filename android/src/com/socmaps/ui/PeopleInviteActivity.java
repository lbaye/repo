...
/**
 * PeopleInvityActivity class is used to send invitation to second degree
 * friends(facebook friends) of user.
 */

public class PeopleInviteActivity extends FragmentActivity implements OnClickListener {
	...
	private void initialize() {
		...
		context = PeopleInviteActivity.this;
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (getItemViewType(position) == RowType.SECOND_DEGREE.ordinal()) {
				return SecondDegreePeopleRowFactoryPeopleInvite.getView(
						...
						context,  convertView,
						imageFetcher, new SecondDegreePeopleItemListener(),
	...
	private void initInvitationDialog() {
		...
		FBUtility.mFacebook.authorize((FragmentActivity) context,
