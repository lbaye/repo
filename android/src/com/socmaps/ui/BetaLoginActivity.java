	...
	public void onClick(View v) {
		...
		if(v == btnLogin)
		{
			if (etPassword.getText().toString().length() == 0) {
				...
				if(etPassword.getText().toString().equals(Constant.betaPassword))
				{
				...
				{
					etPassword.setError("Password does not match. Please try again.");
				}
			}
		}
		else if(v == btnWebsiteLinkBeta)
		{
			Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(Constant.socialmapsWebUrl));
