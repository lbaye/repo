...
class GeotagsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPlaceAccessWillCheckPermission()
    {
        ...
        list($responseCodeForUser1, $responseBody) = sendGetRequest($this->endpoint .'/5003e6f9757df23405000009', array(), $this->user1Headers);
        list($responseCodeForUser2, $responseBody) = sendGetRequest($this->endpoint .'/5003e6f9757df23405000009', array(), $this->user2Headers);
    ...
    public function testPlaceWillBeListedForPermittedUsers()
    {
        ...
        list($responseCode, $responseBody) = sendPutRequest($this->endpoint .'/5003e6f9757df23405000009', $data, $this->user1Headers);
    ...
    public function testPlaceWillBeListedForPermittedCircleUsers()
    {
        ...
        sendPutRequest($this->endpoint .'/5003e6f9757df23405000009', $data, $this->user1Headers);
    ...
    {
        list($responseCode, $responseBody) = sendGetRequest(API_BASEURL .'/me/geotags', array(), $this->user1Headers);
    ...
    {
        sendPutRequest($this->endpoint .'/5003e6f9757df23405000008', array('title' => 'RENAMED'), $this->user1Headers);
        list($responseCode, $responseBody) = sendGetRequest($this->endpoint .'/5003e6f9757df23405000008', array(), $this->user1Headers);
    ...
    {
        list($responseCode, $responseBody) = sendPutRequest($this->endpoint .'/5003e6f9757df23405000099', array('title' => 'RENAMED'), $this->user1Headers);
