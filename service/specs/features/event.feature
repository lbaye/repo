Feature: Events
  ...
  Scenario: Create Event with unauthenticated user
    ...
    And I'm posting "title={rand_string('title')}, description={rand_string('description')}, address={rand_string('address')}, lat=1234, lng=4321, time=2012-11-06 18:07:24 +0600"
  ...
  Scenario: Create Event with authenticated user
    ...
    When I'm sending http "POST" request to "/events"
    And I'm posting "title={rand_string('title')}, description={rand_string('des')}, address={rand_string('address')}, lat=1234, lng=4321, time=2012-11-06 18:07:24 +0600"
  ...
  Scenario: Create Event with authenticated user and Image
    ...
    When I'm sending http "POST" request to "/events"
    And I'm posting with image "title={rand_string('title')}, description={rand_string('des')}, address={rand_string('address')}, lat=1234, lng=4321, time=2012-11-06 18:07:24 +0600"
  ...
  Scenario: Get all public Events
    ...
    And An event is created with "test@example.com" and "abcd" with "title={rand_string('title')}, description={rand_string('description')} ,address={rand_string('address')}, lat=1234, lng=4321, time=2012-11-06 18:07:24 +0600, permission=public"
    And An event is created with "test@example.com" and "abcd" with "title={rand_string('private-title')}, description={rand_string('description')} ,address={rand_string('address')}, lat=1234, lng=4321, time=2012-11-06 18:07:24 +0600, permission=private"
    And I've already setup user account with "xyz@test.com" and "121212"
    And I'm logged in through "xyz@test.com" and "121212"
  ...
  Scenario: Get error message while trying to retrieve unauthorized Event
    Given I've already setup user account with "test@example.com" and "abcd"
    And An event is created with "test@example.com" and "abcd" with "title={rand_string('title')}, description={rand_string('description')} ,address={rand_string('address')}, lat=1234, lng=4321, time=2012-11-06 18:07:24 +0600, permission=private"
    And I've already setup user account with "xyz@test.com" and "121212"
    And I'm logged in through "xyz@test.com" and "121212"
  ...
  Scenario: Update existing Event
    Given I've already setup user account with "test@example.com" and "abcd"
    And An event is created with "test@example.com" and "abcd" with "title={rand_string('title')}, description={rand_string('description')} ,address={rand_string('address')}, lat=1234, lng=4321, time=2012-11-06 18:07:24 +0600"
