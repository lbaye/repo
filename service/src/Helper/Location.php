...
class Location
{
    ...
    {
        $endpoint = $endpoint?: "https://maps.googleapis.com/maps/api/place/search/json?location=$lat,$lng&rankby=distance&types=food&name=harbour&sensor=false&key=". self::PLACES_KEY;
